...
const WorkCard = (props) => {
  return (
    ...
    <div className="img-box h-[230px] w-full relative flex items-center justify-center">
      ...
      <div className="shadow-box w-full h-full flex items-center justify-center rounded-lg bg-black/30 shadow-lg absolute opacity-0 transition-opacity duration-500 ease-in-out hover:opacity-100">
      <a href="" className='w-12 h-12 flex items-center justify-center bg-black/60 rounded-full text-white transition-transform duration-300 ease-in-out hover:scale-110'><i className="fa-brands fa-github fa-xl"></i></a>
      </div>
    </div>
